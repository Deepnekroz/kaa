...
public class ApplicationActor extends UntypedActor {
    ...
    private ActorRef getOrCreateLogActor(String name) {
        ...
        if (logActor == null) {
            logActor = context()
                    .actorOf(Props.create(new ApplicationLogActor.ActorCreator(context, appToken)).withDispatcher(LOG_DISPATCHER_NAME));
    ...
    private ActorRef getOrCreateUserVerifierActor(String name) {
        ...
        if (userVerifierActor == null) {
            userVerifierActor = context().actorOf(Props.create(new ApplicationUserVerifierActor.ActorCreator(context, appToken))
